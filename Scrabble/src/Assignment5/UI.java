...
public class UI {
	...
	public static final int CHALLENGE_REPEAT = 103;
	...
	public void displayCommand (Player player, int commandCode, Word word, String letters) {
		...
		switch (commandCode) {
			...
			case COMMAND_HELP :
				...
				break;
			case COMMAND_PLAY :
				System.out.print(Integer.toString(word.getStartRow() + (int) 'A'));
				System.out.print(Integer.toString(word.getStartColumn() + 1));
